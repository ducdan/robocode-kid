...
public interface Printable {
    ...
    * 
    * @param console - the <code>java.io.PrintStream</code> that the data will be sent to.
    */
    ...
    * 
    * @param output - the <code>java.io.FileOutputStream</code> that the data will be sent to.
    */
