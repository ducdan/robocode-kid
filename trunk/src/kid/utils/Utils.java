...
public class Utils {
   ...
   /**
    * Returns the absolute smaller of two <code>double</code> values. That is, the result is the
    * argument closer to zero. If the arguments have the same value, the result is the first
    * argument. If either value is <code>NaN</code>, then the result is <code>NaN</code>.
    * 
    * @param a
    *           - a number.
    * @param b
   ...
   /**
    * Returns the absolute greater of two <code>double</code> values. That is, the result is the
    * argument farther from zero. If the arguments have the same value, the result is the first
    * argument. If either value is <code>NaN</code>, then the result is <code>NaN</code>.
    * 
    * @param a
    *           - a number.
   ...
   /**
    * Returns the absolute angle in degrees of the <code>double</code> value. That is, the result is
    * between <code>0.0</code> and <code>360.0</code>.
    * 
    * @param n
   ...
   /**
    * Returns the arc sine of an angle, in the range of <code>-180.0</code> though
    * <code>180.0</code>. Special case:
    * <ul>
    * <li>If the argument is <code>NaN</code> or its absolute value is greater than 1, then the
   ...
   /**
    * Returns the arc cosine of an angle, in the range of <code>0.0</code> through
    * <code>180.0</code>. Special case:
    * <ul>
    * <li>If the argument is <code>NaN</code> or its absolute value is greater than 1, then the
    * result is <code>NaN </code>.
   ...
   /**
    * Returns the arc tangent of an angle, in the range of <code>-180.0</code> though
    * <code>180.0</code>. Special case:
    * <ul>
    * <li>If the argument is <code>NaN</code> or its absolute value is greater than 1, then the
    * result is <code>NaN </code>.
   ...
   /**
    * Converts rectangular coordinates (x, y) to compass (r, <i>theta</i>). This method computes the
    * phase <i>theta</i> by computing an arc tangent of x/y in the range of <code>-180.0</code> to
    * <code>180.0</code>. Special cases:
    * <ul>
    * <li>If the argument is <code>NaN</code>, then the result is <code>NaN
    * </code>.
    * <li>If the first argument is positive and the second argument is positive zero, or the first
    * argument is positive infinity and the second argument is positive and finite, then the result
    * is positive zero.
    * <li>If the first argument is positive and the second argument is negative zero, or the first
    * argument is positive infinity and the second argument is negative and finite, then the result
    * is negative zero.
    * <li>If the first argument is negative and the second argument is positive zero, or the first
    * argument is negative infinity and the second argument is positive and finite, then the result
    * is the double value closest to <code>180.0
    * </code>.
    * <li>If the first argument is negative and the second argument is negative zero, or the first
    * argument is negative infinity and the second argument is negative and finite, then the result
    * is the double value closest to <code>-180.0</code>.
    * <li>If the first argument is positive zero or negative zero and the second argument is
    * positive, or the first argument is finite and the second argument is positive infinity, then
    * the result is the double value closest to <code>90.0</code>.
    * <li>If the first argument is positive zero or negative zero and the second argument is
    * negative, or the first argument is finite and the second argument is negative infinity, then
    * the result is the double value closest to <code>
    * -90.0</code>.
    * <li>If both arguments are positive infinity, then the result is the double value closest to
    * <code>45.0</code>.
    * <li>If the first argument is negative infinity and the second argument is positive infinity,
    * then the result is the double value closest to <code>135.0
    * </code>.
    * <li>If the first argument is positive infinity and the second argument is negative infinity,
    * then the result is the double value closest to <code>-45.0</code>.
    * <li>If both arguments are negative infinity, then the result is the double value closest to
    * <code>-135.0</code>.
    * </ul>
    * <p>
    * The computed result must be within 2 ulp of the exact result. Results must be semi-monotonic.
    * <p>
    * Note: "compass" is the coordinate system used in Robocode and is very similar to polar but
    ...
    * @return the <i>theta</i> component of the point (r, <i>theta</i>) in compass coordinates that
   ...
   /**
    * Returns the angle from the first point to the point. That is, the angle from
    * <code>(x1, y1)</code> to <code>(x2, y2)</code>.
    * 
    * @param x1
   ...
   /**
    * Returns the angle from the first robot to the second. That is, the angle from <code>r1</code>
    * to <code>r2</code>.
    * 
    * @param r1
    *           the first robot
   ...
   /**
    * Returns the angle from the first point to the second. That is, the angle from <code>p1</code>
    * to <code>p2</code>.
    * 
    * @param p1
    *           the first point
   ...
   // double, double)
   /**
    * Returns the angle offset that the guess factor will introduce. That is, the angle differing
    * from the the robots position with relation to the guess factor and the maximum escape angle.
    * 
    * @param x
    * @param y
    * @param robot
   ...
   /**
    * Returns the rotation direction. That is, the direction a robot is traveling around a point
    * with 1 being clockwise, and -1 being counter-clockwise.
    * 
    * @param robotHeading
    *           the robot's heading
    * @param robotVelocity
   ...
   /**
    * Returns the maximum escape angle. That is, the greatest angle that a robot well achieve before
    * a bullet reaches it; with relation to the robot's position at time of fire and bullet's firing
    * location.
    * 
    * @param firePower
   ...
   /**
    * Returns the rolling average. That is, the weighted average of the current average and the new
    * reading.
    * 
    * @param value
    *           the current average
