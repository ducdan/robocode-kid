...
public class Colors {
   ...
   public final static Color PINK = new Color(244, 140, 140);
   ...
   public static final Color SKY_BLUE = new Color(80, 180, 180);
   ...
   public final static Color SILVER = new Color(128, 128, 128);

   public final static Color LIGHT_GRAY = new Color(64, 64, 64);

   public final static Color GRAY = new Color(32, 32, 32);

   public final static Color DARK_GRAY = new Color(16, 16, 16);
