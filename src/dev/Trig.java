...
public final class Trig {
   ...
   /**
    * Returns the sine of the given angle measured in radians as computed through the trigonometric
    * tables.
    */
   ...
   /**
    * Returns the cosine of the given angle measured in radians as computed through the
   ...
   /**
    * Returns the tangent of the given angle measured in radians as computed through the
    * trigonometric tables.
    */
   ...
   /**
    * Returns the arc sine (inverse sine) in radians of the given ratio as computed through the
    * trigonometric tables.
    */
   ...
   /**
    * Returns the arc cosine (inverse cosine) in radians of the given ratio as computed through the
    * trigonometric tables.
    */
   ...
   /**
    * Returns the arc tangent (inverse tangent) in radians of the given ratio as computed through
