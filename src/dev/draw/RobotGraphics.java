...
public class RobotGraphics {
   ...
   // }
   //
   // public void drawArc(double x, double y, double circleWidth, double circleHeight, double startAngle, double
   // arcAngle) {
   // graphics.drawArc((int) x, (int) y, (int) circleWidth, (int) circleHeight, (int) startAngle, (int) arcAngle);
   // }
   //
